...
class TestParseUtils {
    ...
    fun testParseJSONToEvents() {
        ...
        assertTrue(event1.date.toString().contains("Tue Jun 09 00:00:00"))
        assertTrue(event1.created.toString().contains("Thu May 23 17:42:20"))
        ...
        assertTrue(event2.date.toString().contains("Fri Jun 19 00:00:00"))
        assertTrue(event2.created.toString().contains("Thu May 23 17:42:20"))
